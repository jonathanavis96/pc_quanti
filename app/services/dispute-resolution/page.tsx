...
export const metadata: Metadata = {
  ...
  description: "Expert dispute resolution, claims preparation, adjudication, and arbitration support for construction and engineering projects. Strategic guidance on contractual dispute resolution procedures backed by nuclear and industrial experience.",
  alternates: {
    canonical: "/services/dispute-resolution",
  },
  openGraph: {
    title: "Dispute Resolution, Adjudication and Arbitration | PC Quanti",
        ...
        <div className="py-16 md:py-24">
          ...
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <Link href="/services/planning" className="p-4 border border-pc-neutral-200 rounded-lg hover:border-pc-gold transition-colors focus:outline-none focus:ring-2 focus:ring-pc-gold focus:ring-offset-2">
                ...
                <p className="text-sm text-pc-neutral-600">Critical path scheduling and forensic delay analysis</p>
              </Link>
            </div>
          </div>
          ...
          <div className="text-center p-8 bg-pc-neutral-50 rounded-lg">
            ...
            <p className="text-pc-neutral-600 mb-6 max-w-2xl mx-auto">
              Contact PC Quanti to discuss how we can help you prepare, assess, or resolve contractual claims and disputes on your industrial project.
            </p>
