          ...
          <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
            ...
            <div>
              <p className="text-pc-neutral-200">
                Engineering and construction management consultancy delivering professional services across the full project lifecycle — from planning through execution and close-out.
              </p>
              <div className="mt-6 space-y-2 text-pc-neutral-200">
                ...
                <div className="flex flex-col gap-3 mt-3">
                  <a
                    ...
                    className="flex items-center gap-2 hover:text-pc-gold transition-colors focus:outline-none focus:ring-2 focus:ring-pc-gold focus:ring-offset-2 focus:ring-offset-[#171717] rounded-sm"
                    aria-label="PC Quanti on LinkedIn"
                  >
                  ...
                  <a
                    href="https://wa.me/27662094919"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 text-[#25D366] hover:text-[#128C7E] transition-colors focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2 focus:ring-offset-[#171717] rounded-sm"
            ...
            <div>
              ...
              <nav className="grid grid-cols-2 gap-x-6 gap-y-2 text-pc-neutral-200 text-sm">
                {siteConfig.services.map((service) => (
                  <Link
                    key={service.slug}
                    href={service.url}
                    className="block whitespace-nowrap hover:text-pc-gold transition-colors focus:outline-none focus:ring-2 focus:ring-pc-gold focus:ring-offset-2 focus:ring-offset-[#171717] rounded-sm"
                  >
                    {service.name}
                  </Link>
                ))}
