            ...
            >
              {navItems.map((item) => (
                <Link
                  ...
                  className="text-pc-neutral-900 font-medium hover:text-pc-blue transition-colors focus:outline-none focus:ring-2 focus:ring-pc-blue focus:ring-offset-2 rounded-sm px-4 py-3"
                  onMouseEnter={() => {
